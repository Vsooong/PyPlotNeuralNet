...
arch2=[
    ...
    to_FcRelu(name="cr1", s_filer=4096, offset="(1.5,0,0)", to="(fc2-east)", width=2, height=2, depth=66,
                      caption="cr1",fill_color='LimeGreen',opacity=0.6),
    to_connection("fc2", "cr1"),

    to_FcRelu(name="cr2", s_filer=4096, offset="(6,0,0)", to="(cr1-east)", width=2, height=2, depth=66,
                      caption="cr2",fill_color='LimeGreen',opacity=0.6),
